...
const routes = {
  '': async () => {
    await import('./home-page.js').then(bundle => bundle && bundle.$homePage || {});
    return html`<home-page></home-page>`;
  },
  '404': async () => {
    await import('./not-found-page.js').then(bundle => bundle && bundle.$notFoundPage || {});
    return html`<not-found-page></not-found-page>`;
  },
  'works': async () => {
    await import('./works-page.js').then(bundle => bundle && bundle.$worksPage || {});
    return html`<works-page></works-page>`;
  },
  'reflections': async () => {
    await import('./reflections-page.js').then(bundle => bundle && bundle.$reflectionsPage || {});
    return html`<reflections-page></reflections-page>`;
  }
};
...
const fetchPageForRoute = (route, options) => {
  ...
  if (routes.hasOwnProperty(immediateRouteData)) {
    ...
    return routes[immediateRouteData]({ ...options,
      subRoute
    });
  } else {
...
var routes$1 = {
  ...
  fetchPageForRoute: fetchPageForRoute
};
